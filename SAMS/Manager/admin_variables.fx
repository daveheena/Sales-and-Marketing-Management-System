...
public class admin_variables
{
	...
	// View Department
	public var lv_dept_nm:String = "";
	public var lv_dept_des:String = "";
	public var lv_dept_name:TextBox;
	public var lv_dept_desc:TextBox;
	public var lv_dept_upBtn: Button;
	public var lv_dept_flag:Boolean = false;
	public var lv_dept_ind: Integer;
	public var lv_dept_len: Integer = 0;
	...
	// View Designation
	public var lv_desig_nm:String = "";
	public var lv_desig_des:String = "";
	public var lv_desig_name:TextBox;
	public var lv_desig_desc:TextBox;
	public var lv_desig_upBtn: Button;
	public var lv_desig_flag:Boolean = false;
	public var lv_desig_ind: Integer;
	public var lv_desig_len: Integer = 0;
